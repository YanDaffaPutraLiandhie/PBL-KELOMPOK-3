    ...
    const fetchConfig = async () => {
      try {
        ...
        if (res.ok) {
          ...
          // Jika data null, pakai defaultConfig
      ...
      <div className={theme}>
        ...
        >
          ...
          <main className="flex flex-col items-center justify-center min-h-[80vh] px-2 pt-6 md:pt-10">
            <div className="w-full max-w-2xl md:max-w-3xl bg-[var(--card-bg)] rounded-2xl shadow-2xl p-4 md:p-8 border border-[var(--border)]">
              {loading && (
              ...
              {/* Jangan render form jika config masih null */}
              {config && (
